                    ...
                    case AnimationMixin.AnimationMixinKind.AnimationClip:
                        EmoteWizardGUI.PropertyFieldWithGenerate(
                            ...
                            () =>
                            {
                                ...
                                var relativePath = $"{context.RelativePath}@@@Generated@@@Mixin_{name.stringValue}.anim";
                    ...
                    case AnimationMixin.AnimationMixinKind.BlendTree:
                        EmoteWizardGUI.PropertyFieldWithGenerate(
                            ...
                            () =>
                            {
                                ...
                                var relativePath = $"{context.RelativePath}@@@Generated@@@Mixin_{name.stringValue}.asset";
