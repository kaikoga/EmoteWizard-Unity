...
namespace Silksprite.EmoteWizardSupport.Tools
{
    public static class EmoteWizardTools
    {
        ...
        public static string ProjectToAbsolutePath(string projectPath) => string.IsNullOrWhiteSpace(projectPath) ? Application.dataPath : Path.Combine(ProjectRoot, projectPath);
    }
}